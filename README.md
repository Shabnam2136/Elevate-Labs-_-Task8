...
## ⚙️ Steps Performed
1. Installed and set up **ProtonVPN** on Windows 11.  
2. Connected to a free server (Netherlands).  
3. Verified changed IP using *whatismyipaddress.com*.  
4. Confirmed encryption and no DNS leaks on *ipleak.net*.  
5. Checked browsing speed before and after VPN connection.  
